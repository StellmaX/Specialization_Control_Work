...
Программа предназначена для ведения учета и управления данными о домашних и вьючных животных.
Она предоставляет консольный интерфейс для просмотра и редактирования и добавления новых данных о животных, а также для
сохранения и загрузки информации в файл в формате JSON.

#### Основные функции программы

1. **Добавление нового животного:**
    - Позволяет добавить новое животное, выбрав его тип (кошка, собака, хомяк, лошадь, верблюд или осел), введя
      имя и дату рождения.
...
2. **Список команд животного:**
    - Позволяет вывести список команд, которые может выполнять конкретное животное. Для этого пользователю нужно ввести имя
      животного.

3. **Обучение новым командам:**
    - Позволяет обучить животное новым командам, добавив их в список команд животного. Для этого пользователю нужно ввести
      имя животного и новую команду.

4. **Вывод списка животных по дате рождения:**
    - Позволяет вывести список всех животных, отсортированных по дате рождения в формате `DD.MM.YYYY`.

5. **Сохранение данных:**
    - Позволяет сохранить текущие данные реестра животных в файл JSON. При сохранении все текущие данные
      перезаписываются в файл.

6. **Вывод общего количества созданных животных:**
    - Позволяет вывести на экран общее количество созданных животных любого типа. Этот счетчик увеличивается
      каждый раз при добавлении пользователем нового животного.
...
Необходимо добавить в проект зависимость для `Gson`.